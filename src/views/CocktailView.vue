      ...
      <main class="main-content">
        <div class="container">
          ...
          <div v-else-if="error" class="error">
            <h2>Loading Error</h2>
            <p>{{ error }}</p>
            <button @click="cocktailStore.retryLoad" class="retry-button">Try Again</button>
          </div>
...
const isMobileNavOpen = computed(() => cocktailStore.isMobileNavOpen)
...
const closeMobileNav = () => {
  cocktailStore.closeMobileNav()
  scrollToTop()
}

const loadCocktails = async () => {
  cocktailStore.setActiveCategory(currentCode.value)
}
